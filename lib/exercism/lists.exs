...
IO.puts(LanguageList.new() |> inspect())
IO.puts(LanguageList.add(LanguageList.new(), "Clojure") |> inspect())
IO.puts(LanguageList.add(LanguageList.add(LanguageList.new(), "Clojure"), "Haskell") |> inspect())
IO.puts(LanguageList.remove(LanguageList.add(LanguageList.new(), "Clojure")) |> inspect())
