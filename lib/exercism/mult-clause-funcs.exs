...
IO.puts(GuessingGame.compare(5, 5))   # => "Correct"
IO.puts(GuessingGame.compare(5, 8))   # => "Too high"
IO.puts(GuessingGame.compare(5, 2))   # => "Too low"
IO.puts(GuessingGame.compare(5, 6))   # => "So close"
IO.puts(GuessingGame.compare(5, 4))   # => "So close"
IO.puts(GuessingGame.compare(5))      # => "Make a guess"
IO.puts(GuessingGame.compare(5, :no_guess))   # => "Make a guess"
