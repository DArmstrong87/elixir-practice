defmodule NameBadge do
  def print(id, name, department) do
    ...
    if id == nil, do: name_department, else: "[#{id}] - #{name_department}"
  end
end

IO.puts(NameBadge.print(67, "Katherine Williams", "Strategic Communication"))
IO.puts(NameBadge.print(nil, "Robert Johnson", "Procurement"))
IO.puts(NameBadge.print(204, "Rachel Miller", nil))
IO.puts(NameBadge.print(nil, "Rachel Miller", nil))
