defmodule Form do
  ...
  """
  @type length_check() :: :ok | {:error, pos_integer()}
  @spec check_length(word :: String.t(), length :: non_neg_integer()) :: length_check()
  ...
  @type address() :: %{
          street: non_neg_integer(),
          postal_code: non_neg_integer(),
          city: String.t()
        }
  @spec format_address(address()) :: map()
  def format_address(%{street: street, postal_code: postal_code, city: city}) do
    format_address({street, postal_code, city})
  end

  @type address_tuple() :: {String.t(), String.t(), String.t()}
  @spec format_address(address_tuple()) :: String.t()
